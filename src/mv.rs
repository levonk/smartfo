...
pub fn plain_mv(
    ...
    if !handle_dest_exists(dest, no_clobber, force, interactive, backup, quiet, dry_run)? {
...
mod tests {
    ...
    fn test_handle_dest_exists_no_clobber() {
        ...
        let result = handle_dest_exists(dest, true, false, false, false, false, false);
    ...
    fn test_handle_dest_exists_force() {
        ...
        let result = handle_dest_exists(dest, false, true, false, false, false, false);
    ...
    fn test_handle_dest_not_exists() {
        ...
        let result = handle_dest_exists(dest, false, false, false, false, false, false);
        assert_eq!(result.unwrap(), true);
    }
    ...
    fn test_plain_mv_same_path() {
        ...
        let result = plain_mv(source, dest, false, false, false, false, false, false);
        assert!(result.is_ok());
    }
    ...
    fn test_plain_mv_no_clobber() {
        ...
        let result = plain_mv(source, dest, true, false, false, false, false, false);
    ...
    fn test_dest_exists_all_modes() {
        ...
        assert_eq!(handle_dest_exists(dest, true, false, false, false, false, false).unwrap(), false);

        // Test force mode
        assert_eq!(handle_dest_exists(dest, false, true, false, false, false, false).unwrap(), true);

        // Test backup mode
        assert_eq!(handle_dest_exists(dest, false, false, false, true, false, false).unwrap(), true);
    ...
    fn test_plain_mv_all_scenarios() {
        ...
        assert!(plain_mv(source, source, false, false, false, false, false, false).is_ok());

        // Test non-existent source (should fail)
        assert!(plain_mv(source, dest, false, false, false, false, false, false).is_err());
    }
